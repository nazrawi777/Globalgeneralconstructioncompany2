...
from .models import (
    HomeSlider, Service, AboutTeam, Testimonial, Project,
    BlogPost, JobVacancy, Partner, VideoGalleryItem
)
...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['sliders'] = HomeSlider.objects.filter(is_active=True).order_by('-created_at')
