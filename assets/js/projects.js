...
(function () {
  ...
  const SAMPLE_VIDEOS = {
    construction1:
      "https://xgmbwiggqvpcezeqlajv.supabase.co/storage/v1/object/public/hero/video_2026-01-02_12-06-25.mp4",
    construction2:
      "https://xgmbwiggqvpcezeqlajv.supabase.co/storage/v1/object/public/hero/video_2026-01-02_12-06-25.mp4",
    construction3:
      "https://xgmbwiggqvpcezeqlajv.supabase.co/storage/v1/object/public/hero/video_2026-01-02_12-06-25.mp4",
  ...
  const PROJECT_CATEGORIES = JSON.parse(
    JSON.parse(document.getElementById("project-categories-data").textContent),
  );
  const PROJECTS_DATA = JSON.parse(
    JSON.parse(document.getElementById("projects-data").textContent),
  );

  const PROJECTS =
    PROJECTS_DATA && PROJECTS_DATA.length
      ? PROJECTS_DATA
      : [
          {
            id: "1",
            ...
            media: [
              {
                id: "1a",
                type: "image",
                src: "https://i.postimg.cc/D086rHdB/Megenagna_Skyline_Addis_Ababa_(2).jpg",
                alt: "2B+G+15 tower — structural frame and facade works",
                aspectRatio: 0.8,
              },
              {
                id: "1b",
                type: "image",
                src: "https://i.postimg.cc/R0bqjLqz/Addis_Ababa_Ethiopia_(3).jpg",
                alt: "2B+G+15 tower — structural frame and facade works",
                aspectRatio: 0.8,
              },

              {
                id: "1c",
                type: "video",
                src: SAMPLE_VIDEOS.construction1,
                thumbnail: "assets/images/skyline-tower.jpg",
                alt: "2B+G+15 tower construction timelapse",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                id: "2a",
                type: "video",
                src: SAMPLE_VIDEOS.timelapse1,
                thumbnail:
                  "https://i.postimg.cc/R0bqjLqz/Addis_Ababa_Ethiopia_(3).jpg",
                alt: "Shiromeda commercial centre renovation — drone flythrough",
                aspectRatio: 1.78,
              },
              {
                id: "2a",
            ...
            media: [
              {
                id: "3a",
                type: "image",
                src: "https://i.postimg.cc/W1VHmJM7/2022.jpg",
                alt: "Dormitory building — reinforced concrete and finishing works",
                aspectRatio: 1.33,
              },
              {
                id: "3b",
                type: "video",
                src: SAMPLE_VIDEOS.construction2,
                thumbnail: "https://i.postimg.cc/PJxt5Rqh/202312.jpg",
                alt: "Dormitory construction progress timelapse",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                id: "4a",
                type: "image",
                src: "https://i.postimg.cc/d1ZbNcDB/202412.jpg",
                alt: "Japanese garden restoration — stonework, planting and walkway detail",
                aspectRatio: 1.0,
              },
            ],
          },
          {
            id: "5",
            title:
              "Office Campus & Service Facilities — Rigid Pavement & Utilities",
            location: "Addis Ababa, Ethiopia",
            year: 2024,
            category: "commercial",
            categoryLabel: "Commercial & Offices",
            media: [
              {
                id: "5a",
                type: "image",
                src: "https://i.postimg.cc/4ymQTC7P/NATIONAL_PALACE_(1).jpg",
                alt: "Office campus — rigid pavement, landscaping and utility works",
                aspectRatio: 0.8,
              },
              {
                id: "5b",
                type: "video",
                src: SAMPLE_VIDEOS.timelapse2,
                thumbnail: "assets/images/nexus-hub.jpg",
                alt: "Office campus construction timelapse",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                id: "6a",
                type: "video",
                src: SAMPLE_VIDEOS.construction3,
                thumbnail:
                  "https://i.postimg.cc/qR0sgBG1/photo_2026_01_04_02_13_36.jpg",
                alt: "Reservoir and pipeline installation — commissioning sequence",
                aspectRatio: 1.78,
              },
              {
                id: "6b",
                type: "image",
                src: "https://i.postimg.cc/pTxfyVB0/photo_2026_01_04_02_13_59.jpg",
                alt: "Reservoir construction — concrete lining and inlet works",
                aspectRatio: 1.33,
              },
            ],
          },
          {
            id: "7",
            title:
              "Hassen Garage — Walkway, Bike Lane & Smart Poles (Segment C)",
            location: "Jimma, Ethiopia",
            year: 2024,
            category: "sustainable",
            categoryLabel: "Sustainable & Green",
            media: [
              {
                id: "7a",
                type: "image",
                src: "https://i.postimg.cc/JzycFWVL/Forest_(1).jpg",
                alt: "Walkway and bike lane installation with smart pole lighting",
                aspectRatio: 1.33,
              },
              {
                id: "7b",
                type: "image",
                src: "https://i.postimg.cc/HsNFMb5P/corriderjimma.jpg",
                alt: "Walkway and bike lane installation with smart pole lighting",
                aspectRatio: 1.33,
              },
              {
                id: "7c",
                type: "video",
                src: SAMPLE_VIDEOS.drone1,
                thumbnail: "assets/images/marina-resort.jpg",
                alt: "Jimma corridor segment drone tour",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                ...
                type: "image",
                src: "https://i.postimg.cc/HsNFMb5P/corriderjimma.jpg",
                alt: "Jimma corridor — road upgrading and drainage construction",
                aspectRatio: 1.33,
              },
              {
                id: "8b",
            ...
            media: [
              {
                id: "9a",
                type: "image",
                src: "https://i.postimg.cc/FzDp3mLd/Palácio_Nacional_residência_oficial_do_presidente_da_Etiópia.jpg",
                alt: "National Palace restoration — heritage masonry and pavement works",
                aspectRatio: 1.33,
              },
              {
                id: "9b",
                type: "video",
                src: SAMPLE_VIDEOS.construction1,
                thumbnail: "https://i.postimg.cc/KjKMjsk5/Ethiopia_(1).jpg",
                alt: "National Palace restoration timelapse",
                aspectRatio: 1.78,
              },
            ],
          },
          {
            id: "10",
            title:
              "Wolita Damot Sore Health Centre — Administrative & Laboratory Blocks",
            ...
            media: [
              {
                id: "10a",
                type: "image",
                src: "https://i.postimg.cc/509JsRLw/202314.jpg",
                alt: "Health centre — administrative and laboratory block exterior",
                aspectRatio: 1.33,
              },
              {
                id: "10b",
                type: "image",
                src: "https://i.postimg.cc/76L656sr/202513.jpg",
                alt: "Health centre — administrative and laboratory block exterior",
                aspectRatio: 1.33,
              },
            ],
            ...
            media: [
              {
                ...
                alt: "Road upgrading timelapse — pavement and drainage works",
                aspectRatio: 1.78,
              },
              {
                id: "11b",
                type: "image",
                src: "https://i.postimg.cc/PJxt5Rqh/202312.jpg",
                alt: "Road upgrading — asphalt overlay and culverts",
                aspectRatio: 1.6,
              },
            ],
          },
            ...
            media: [
              {
                id: "12a",
                type: "image",
                src: "https://i.postimg.cc/prTFMkbK/202512.jpg",
                alt: "Commercial centre site works — fencing and site preparation",
                aspectRatio: 1.33,
              },
              {
                id: "12b",
                type: "video",
                src: SAMPLE_VIDEOS.construction2,
                thumbnail: "https://i.postimg.cc/hvJHwWjj/2023.jpg",
                alt: "Site operations video — site clearance and groundwork",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                id: "13a",
                type: "image",
                src: "https://i.postimg.cc/bNyy6dHp/202111.jpg",
                alt: "Japanese garden landscaping — walkway and planting details",
                aspectRatio: 1.0,
              },
              {
                id: "13b",
                type: "video",
                src: SAMPLE_VIDEOS.timelapse2,
                thumbnail: "https://i.postimg.cc/VN0YpQC4/download_(1).jpg",
                alt: "Landscape works timelapse — planting and irrigation",
                aspectRatio: 1.78,
              },
            ],
          },
          {
            id: "14",
            title:
              "Shiromeda Commercial Centre — Renovation (alternate sector)",
            location: "Addis Ababa, Ethiopia",
            year: 2024,
            category: "commercial",
            categoryLabel: "Commercial & Offices",
            ...
            media: [
              {
                id: "14a",
                type: "image",
                src: "https://i.postimg.cc/1RjgNG1b/2025.jpg",
                alt: "Commercial renovation — facade and night lighting study",
                aspectRatio: 0.7,
              },
              {
                id: "14b",
                type: "video",
                src: SAMPLE_VIDEOS.drone1,
                thumbnail: "https://i.postimg.cc/X7mPrzvf/2021_(1).png",
                alt: "Renovation/lighting drone showcase",
                aspectRatio: 1.78,
              },
            ],
          },
            ...
            media: [
              {
                id: "15a",
                type: "image",
                src: "https://i.postimg.cc/1z2Tq7MZ/2024.jpg",
                alt: "Site finishes — paving, landscaping and external works",
                aspectRatio: 1.33,
              },
            ],
          },
  ...
  const icons = {
    ...
    volumeX:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="22" x2="16" y1="9" y2="15"/><line x1="16" x2="22" y1="9" y2="15"/></svg>',
    maximize:
    ...
    loader:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="loading-spinner"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>',
  };
  ...
  function renderGallery() {
    ...
    elements.galleryGrid.innerHTML = visible
  ...
  function navigateMedia(direction) {
    ...
    state.currentMediaIndex =
      (state.currentMediaIndex + direction + total) % total;
    renderLightbox();
  }
  ...
  function init() {
    ...
    // Event listeners
    elements.filterScrollLeft.addEventListener("click", () =>
      scrollFilters("left"),
    );
    elements.filterScrollRight.addEventListener("click", () =>
      scrollFilters("right"),
    );
    elements.filterList.addEventListener(
      "scroll",
      debounce(updateScrollButtons, 100),
    );
